...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<BajaDeStock> BajaDeStocks { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BajaDeStock>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("BajaDeStock");
        ...
        {
            entity.HasKey(e => e.IdHistorialToken).HasName("PK__Historia__03DC48A5A8533532");
            ...
            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.HistorialRefreshTokens)
                ...
                .HasConstraintName("FK__Historial__IdUsu__76B698BF");
        });
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("MelTrigger1_ProductChange"));
        ...
        {
            entity.HasKey(e => e.ChangeId).HasName("PK__Products__0E05C5B73696D5B4");

            entity.ToTable("ProductsAudit");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF97C01CF63F");
